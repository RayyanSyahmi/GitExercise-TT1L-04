...
class Sidebar(QtWidgets.QWidget):
    def __init__(self, canvas):
        ...
        self.fill_color_button = QtWidgets.QPushButton('Fill in')
        self.fill_color_button.clicked.connect(self.fill_color)

        self.color_pickout_button = QtWidgets.QPushButton('Pickout color')
        self.color_pickout_button.clicked.connect(self.color_pickout)
        ...
        layout.addWidget(self.color_pickout_button)
